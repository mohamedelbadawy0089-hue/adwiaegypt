# -*- coding: utf-8 -*-
"""Fetch real pharmacy data from OpenStreetMap for Egypt"""
...
try:
    response = requests.post(overpass_url, data=query, headers=headers, timeout=180)
    ...
    if response.status_code == 200:
        ...
        for el in elements:
            ...
            if not name or 'pharmacy' in name.lower() and len(name) < 10:
